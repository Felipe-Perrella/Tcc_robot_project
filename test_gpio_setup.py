...
class BrushController:
    ...
    def __init__(self, brush_pins, servo_pin, brush_speed=80):
        ...
        # Configurar pinos como saída (um por um)
        GPIO.setup(self.pins['brush_1']['in1'], GPIO.OUT)
        GPIO.setup(self.pins['brush_1']['in2'], GPIO.OUT)
        GPIO.setup(self.pins['brush_1']['enable'], GPIO.OUT)
        GPIO.setup(self.pins['brush_2']['in1'], GPIO.OUT)
        GPIO.setup(self.pins['brush_2']['in2'], GPIO.OUT)
        GPIO.setup(self.pins['brush_2']['enable'], GPIO.OUT)
